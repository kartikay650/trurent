...
// Exposed so the UI and Claude prompt can stay in sync about canonical values.
export const CANONICAL_AMENITIES = ["gym", "pool", "parking", "power_backup", "garden", "security", "club"];
export const CANONICAL_FURNISHED = ["fully", "semi", "unfurnished"];
export const CANONICAL_SOURCES = ["nobroker", "magicbricks", "99acres"];

// Exported for tests + the Claude prompt.
